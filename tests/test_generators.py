from src.generators import filter_by_money, transaction_info


def test_transaction_info() -> None:
    assert list(
        transaction_info(
            [
                {
...
def test_filter_by_money() -> None:
    ...
    ) == {"id": 939719570, "operationAmount": {"currency": {"code": "USD", "name": "USD"}}}
